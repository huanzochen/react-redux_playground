...
import { bindAllValue, getWindowObject, getViewport } from '../../utils/common/base'
...
class DetectBreakPoint extends Component {
  ...
  getDefaultBreakpoint() {
    return last(this.getNormalizedBreakpoints()) || { symbol: undefined, value: 0 }
  }

  getCurrentBreakpoint() {
    const { width } = getViewport()
    return getBreakpoint(width, this.getNormalizedBreakpoints()) || this.getDefaultBreakpoint()
  }
